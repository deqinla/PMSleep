...
def main():
    ...
    parser.add_argument("--data_dir", type=str, default="E:\sleepstage\sleepdata\sleep2013_or",
        ...
        for s in range(psg_f.signals_in_file):
            for sj in range(len(select_ch)):
                if ch_names[s] == select_ch[sj]:
                    ...
                    break
        if len(select_ch_idx) != len(select_ch):
